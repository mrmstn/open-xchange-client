...
defmodule OpenXchangeClient.Model.FolderDataComOpenexchangeCalendarExtendedProperties do
  ...
  @type t :: %__MODULE__{
    ...
    :"lastUpdate" => OpenXchangeClient.Model.FolderDataComOpenexchangeCalendarExtendedPropertiesLastUpdate.t | nil
  }
end

defimpl Poison.Decoder, for: OpenXchangeClient.Model.FolderDataComOpenexchangeCalendarExtendedProperties do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"lastUpdate", :struct, OpenXchangeClient.Model.FolderDataComOpenexchangeCalendarExtendedPropertiesLastUpdate, options)
  end
end
