...
defmodule OpenXchangeClient.Model.AnalysisChangeNewEvent do
  @moduledoc """
  The new event defined by the given ical.
  """
...
defimpl Poison.Decoder, for: OpenXchangeClient.Model.AnalysisChangeNewEvent do
