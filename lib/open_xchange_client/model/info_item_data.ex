...
defmodule OpenXchangeClient.Model.InfoItemData do
  ...
  @type t :: %__MODULE__{
    ...
    :"com.openexchange.share.extendedObjectPermissions" => [OpenXchangeClient.Model.InfoItemExtendedPermission.t] | nil,
...
defimpl Poison.Decoder, for: OpenXchangeClient.Model.InfoItemData do
  ...
  def decode(value, options) do
    value
    |> deserialize(:"object_permissions", :list, OpenXchangeClient.Model.InfoItemPermission, options)
    |> deserialize(:"com.openexchange.share.extendedObjectPermissions", :list, OpenXchangeClient.Model.InfoItemExtendedPermission, options)
  end
end
