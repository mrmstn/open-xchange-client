...
defmodule OpenXchangeClient.Model.AnalysisChangeMasterEvent do
  @moduledoc """
  The master event in case this is an exception.
  """
...
defimpl Poison.Decoder, for: OpenXchangeClient.Model.AnalysisChangeMasterEvent do
