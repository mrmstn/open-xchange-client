...
defmodule OpenXchangeClient.Model.AnalysisChangeCurrentEvent do
  @moduledoc """
  The current event as it already exists in the system.
  """
...
defimpl Poison.Decoder, for: OpenXchangeClient.Model.AnalysisChangeCurrentEvent do
